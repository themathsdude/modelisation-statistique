...
Nous avons déjà une première idée des corrélations entre nos variables grâce à l'analyse bi-variée. Formalisons ces relations et trouvons les coefficients $\beta_j$ et la loi d' $\varepsilon$. Dans le but de pouvoir comparer les $\beta_j$, nous devons centrer-réduire nos données.  
