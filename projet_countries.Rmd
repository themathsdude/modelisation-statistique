...
qq.plot <- qq.plot + xlab("Quantiles empiriques des résidus") + ylab("Quantiles d'une loi de Student T(n-p-1)") + labs(title="QQ-plot quantiles des résidus studentisés contre quantiles théoriques, ANOVA nord-sud") + theme(plot.title = element_text(hjust = 0.5))
qq.plot
```
