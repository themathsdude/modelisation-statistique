...
En analysant maintenant les nuages du points des paires de variables, on en déduit que:
...
Nous allons terminer cette partie en nous intéressant à la variables Région, qui est une variable qualitative. Traçons le boxplot de la variable $T$ pour chaque modalité de la variables Région. 
